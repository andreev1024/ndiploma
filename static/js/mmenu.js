...
//Add event from js the keep the marup clean
    ...
    function init2() {
        document.getElementById("menu-toggle2").addEventListener("click", toggleMenu);
    }
...
$(document).ready(function () {
    ...
    $('.rev-item').slick({
        ...
        slidesToShow: 1,
        slidesToScroll: 1,
        prevArrow: '<span data-role="none" style="color: black;font-size: 18px;font-weight: bolder;display: block;text-align: center;line-height: 43px;" class="slick-prev animate" aria-label="Previous" tabindex="0" role="button"> < </span>',
        nextArrow: '<span data-role="none" style="color: black;font-size: 18px;font-weight: bolder;display: block;text-align: center;line-height: 43px;" class="slick-next animate" aria-label="Next" tabindex="0" role="button"> > </span>'
    });
 ...
 * Copyright (c) 2016 JÃ¶rn Zaefferer; Licensed MIT */
    ...
    jQuery.validator.addMethod("num2", function (value, element) {
        ...
        return this.optional(element) || /[A-Za-z0-9](\_){0,5}$/.test(value);
    ...
    $("form").each(function () {
        ...
        messages: {
            ...
            phone: "Введите все цифры в номере"
...
jQuery.validator.addMethod("num2", function(value, element) {
        // allow any non-whitespace characters as the host part
        return this.optional( element ) || /[A-Za-z0-9](\_){0,0}$/.test( value );
    },'Please enter a valid number');

$(function () {
   /* $("input[name=phone]").mask("375-(99)-999-99-99?99999");*/
});
